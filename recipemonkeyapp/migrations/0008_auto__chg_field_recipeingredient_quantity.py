...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecipeIngredient.quantity'
        db.alter_column('recipemonkeyapp_recipeingredient', 'quantity', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'RecipeIngredient.quantity'
        db.alter_column('recipemonkeyapp_recipeingredient', 'quantity', self.gf('django.db.models.fields.IntegerField')())
