...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserFoodPrefs.foodprefrences'
        db.delete_column('recipemonkeyapp_userfoodprefs', 'foodprefrences')

        # Adding field 'UserFoodPrefs.foodpreferences'
        db.add_column('recipemonkeyapp_userfoodprefs', 'foodpreferences', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserFoodPrefs.foodprefrences'
        db.add_column('recipemonkeyapp_userfoodprefs', 'foodprefrences', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Deleting field 'UserFoodPrefs.foodpreferences'
        db.delete_column('recipemonkeyapp_userfoodprefs', 'foodpreferences')
    ...
    models = {
        ...
        'recipemonkeyapp.storagelog': {
            ...
            'dateChanged': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 11, 5, 5, 21, 27, 756007)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
            'storage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipemonkeyapp.Storage']"})
        ...
        'recipemonkeyapp.userfoodprefs': {
            ...
            'foodpreferences': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
