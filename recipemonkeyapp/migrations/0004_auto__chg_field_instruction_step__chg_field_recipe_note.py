...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Instruction.step'
        db.alter_column('recipemonkeyapp_instruction', 'step', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Recipe.note'
        db.alter_column('recipemonkeyapp_recipe', 'note', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Instruction.step'
        db.alter_column('recipemonkeyapp_instruction', 'step', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'Recipe.note'
        db.alter_column('recipemonkeyapp_recipe', 'note', self.gf('django.db.models.fields.CharField')(max_length=2048))
    ...
    models = {
        ...
        'recipemonkeyapp.recipe': {
            ...
            'instructions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['recipemonkeyapp.Instruction']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
