...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StorageItem.barcode'
        db.add_column('recipemonkeyapp_storageitem', 'barcode',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StorageItem.barcode'
        db.delete_column('recipemonkeyapp_storageitem', 'barcode')
    ...
    models = {
        ...
        'recipemonkeyapp.groceryitem': {
            ...
            'Meta': {'ordering': "['name']", 'object_name': 'GroceryItem'},
        ...
        'recipemonkeyapp.storageitem': {
            ...
            'barcode': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
