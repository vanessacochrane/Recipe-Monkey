...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('recipemonkeyapp_groceryitem', (
            ...
            ('seasonStart', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('seasonEnd', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipemonkeyapp.Store'], null=True, blank=True)),
            ('tescoid', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('seasonal', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('EANBarcode', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal('recipemonkeyapp', ['GroceryItem'])

        # Adding model 'GroceryItemInfo'
        db.create_table('recipemonkeyapp_groceryiteminfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('unitType', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ...
        db.send_create_signal('recipemonkeyapp', ['GroceryItemInfo'])
        ...
        # Adding model 'PlannerMeal'
        db.create_table('recipemonkeyapp_plannermeal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipemonkeyapp.Recipe'])),
            ('planner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipemonkeyapp.Planner'])),
            ('course', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('recipemonkeyapp', ['PlannerMeal'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GroceryItemInfo'
        db.delete_table('recipemonkeyapp_groceryiteminfo')
        ...
        # Deleting model 'PlannerMeal'
        db.delete_table('recipemonkeyapp_plannermeal')
    ...
    models = {
        ...
        'recipemonkeyapp.recipe': {
            ...
            'subrecipes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'subRecipes'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['recipemonkeyapp.Recipe']"})
        },
