...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroceryItem.unitcost'
        db.add_column('recipemonkeyapp_groceryitem', 'unitcost', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'GroceryItem.unitweight'
        db.add_column('recipemonkeyapp_groceryitem', 'unitweight', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroceryItem.unitcost'
        db.delete_column('recipemonkeyapp_groceryitem', 'unitcost')

        # Deleting field 'GroceryItem.unitweight'
        db.delete_column('recipemonkeyapp_groceryitem', 'unitweight')
    ...
    models = {
        ...
        'recipemonkeyapp.storagelog': {
            ...
            'dateChanged': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 11, 6, 5, 11, 13, 20399)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
            'storage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipemonkeyapp.Storage']"})
