...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.cuisine'
        db.alter_column('recipemonkeyapp_recipe', 'cuisine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipemonkeyapp.Cuisine'], null=True))

        # Changing field 'Recipe.serving'
        db.alter_column('recipemonkeyapp_recipe', 'serving', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Recipe.course'
        db.alter_column('recipemonkeyapp_recipe', 'course', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Recipe.note'
        db.alter_column('recipemonkeyapp_recipe', 'note', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Recipe.source'
        db.alter_column('recipemonkeyapp_recipe', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipemonkeyapp.Source'], null=True))

        # Changing field 'Recipe.servingMeasure'
        db.alter_column('recipemonkeyapp_recipe', 'servingMeasure', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Changing field 'Recipe.cuisine'
        db.alter_column('recipemonkeyapp_recipe', 'cuisine_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['recipemonkeyapp.Cuisine']))

        # Changing field 'Recipe.serving'
        db.alter_column('recipemonkeyapp_recipe', 'serving', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Recipe.course'
        db.alter_column('recipemonkeyapp_recipe', 'course', self.gf('django.db.models.fields.CharField')(default=1, max_length=256))

        # Changing field 'Recipe.note'
        db.alter_column('recipemonkeyapp_recipe', 'note', self.gf('django.db.models.fields.TextField')(default=1))

        # Changing field 'Recipe.source'
        db.alter_column('recipemonkeyapp_recipe', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['recipemonkeyapp.Source']))

        # Changing field 'Recipe.servingMeasure'
        db.alter_column('recipemonkeyapp_recipe', 'servingMeasure', self.gf('django.db.models.fields.CharField')(default=1, max_length=256))
