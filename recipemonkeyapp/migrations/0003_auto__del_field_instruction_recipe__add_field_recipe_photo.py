...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('recipemonkeyapp_recipe', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('recipemonkeyapp_recipe', 'photo')
