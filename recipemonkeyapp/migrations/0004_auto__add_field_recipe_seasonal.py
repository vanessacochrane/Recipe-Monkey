...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recipe.seasonal'
        db.add_column('recipemonkeyapp_recipe', 'seasonal', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Recipe.seasonal'
        db.delete_column('recipemonkeyapp_recipe', 'seasonal')
