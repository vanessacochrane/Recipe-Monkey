...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StorageItem.quantityMeasure'
        db.add_column('recipemonkeyapp_storageitem', 'quantityMeasure', self.gf('django.db.models.fields.CharField')(default=1, max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StorageItem.quantityMeasure'
        db.delete_column('recipemonkeyapp_storageitem', 'quantityMeasure')
    ...
    models = {
        ...
        'recipemonkeyapp.storagelog': {
            ...
            'dateChanged': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 11, 5, 5, 52, 31, 803571)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
            'storage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipemonkeyapp.Storage']"})
