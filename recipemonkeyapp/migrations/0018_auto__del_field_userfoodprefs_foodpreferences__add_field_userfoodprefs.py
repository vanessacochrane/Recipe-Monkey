...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserFoodPrefs.preferences'
        db.add_column('recipemonkeyapp_userfoodprefs', 'preferences', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserFoodPrefs.preferences'
        db.delete_column('recipemonkeyapp_userfoodprefs', 'preferences')
    ...
    models = {
        ...
        'recipemonkeyapp.storagelog': {
            ...
            'dateChanged': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 11, 5, 5, 21, 51, 138903)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
            'storage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipemonkeyapp.Storage']"})
        ...
        'recipemonkeyapp.userfoodprefs': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'preferences': ('django.db.models.fields.TextField', [], {'null': 'True'}),
