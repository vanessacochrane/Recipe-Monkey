...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroceryItem.tescoName'
        db.add_column('recipemonkeyapp_groceryitem', 'tescoName', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Changing field 'GroceryItem.tescoid'
        db.alter_column('recipemonkeyapp_groceryitem', 'tescoid', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))


    def backwards(self, orm):
        
        # Deleting field 'GroceryItem.tescoName'
        db.delete_column('recipemonkeyapp_groceryitem', 'tescoName')

        # Changing field 'GroceryItem.tescoid'
        db.alter_column('recipemonkeyapp_groceryitem', 'tescoid', self.gf('django.db.models.fields.CharField')(default=0, max_length=256))
    ...
    models = {
        ...
        'recipemonkeyapp.groceryitem': {
            ...
            'tescoName': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'tescoid': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'})
        },
