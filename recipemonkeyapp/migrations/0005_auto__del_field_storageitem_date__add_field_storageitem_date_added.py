...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('recipemonkeyapp_storageitem', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Deleting field 'StorageItem.date_added'
        db.delete_column('recipemonkeyapp_storageitem', 'date_added')
