...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StorageLog.dateUsed'
        db.delete_column('recipemonkeyapp_storagelog', 'dateUsed')

        # Adding field 'StorageLog.dateChanged'
        db.add_column('recipemonkeyapp_storagelog', 'dateChanged', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'StorageLog.dateUsed'
        db.add_column('recipemonkeyapp_storagelog', 'dateUsed', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'StorageLog.dateChanged'
        db.delete_column('recipemonkeyapp_storagelog', 'dateChanged')
    ...
    models = {
        ...
        'recipemonkeyapp.storagelog': {
            ...
            'dateChanged': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
            'storage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['recipemonkeyapp.Storage']"})
